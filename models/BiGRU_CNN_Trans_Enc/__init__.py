...
class BiGRU_CNN_Trans_Enc(nn.Module):
    def __init__(self, input_shape, emb_tech, hidden_size=256, device=device, gru_layer=2, kerner_size=[2,3,4,5], cnn_filter=128, trans_layer=2, num_head=8, dropout=0.1):
